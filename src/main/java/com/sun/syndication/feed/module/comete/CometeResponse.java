...
public interface CometeResponse{
    ...
    /**
     * #  link – a reference back to the Comete Description file
     * 
     ...
     *    * Note: New in version 1.1.
     *    * Requirements: May appear zero or one time.
     * @return link to the comete spec.
     */
    public Link getLink();
    
    // list of OSResponseQuery interfaces
    /**
     * <code>Query</code> – in an Comete Response, can be used both to echo back the original query and to suggest new searches.
     *  Please see the <a href="../query/">Comete Query specification</a> for more information.
     *     <ul>
