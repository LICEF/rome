...
public class DCModuleImpl extends ModuleImpl implements DCModule {
    ...
    public LangString getTitle() {
        return ((_title != null) && (_title.size() > 0)) ? (LangString) _title.get(0) : null;
    }
    ...
    public LangString getDescription() {
        return ((_description != null) && (_description.size() > 0)) ?
                (LangString) _description.get(0) : null;
    }
    ...
    static {
        ...
        basePropInterfaceMap.put("titles", LangString.class);
        basePropInterfaceMap.put("creators", String.class);
        basePropInterfaceMap.put("subjects", DCSubject.class);
        basePropInterfaceMap.put("descriptions", LangString.class);
